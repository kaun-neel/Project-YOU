...
Full-width transparent bar sitting on the Slate Veil canvas. Left: wordmark 'ProJect YOU' at 17–18px weight 400 in #fffdf9. Right: nav items (EXPERTISE, WORK, TEAM, CAREERS) at 14–15px weight 400 in #fffdf9, 15px horizontal gap, plus the outlined CONTACT button at the far right with 5px corner radius and 9px/15px padding. No background fill, no border, no shadow.
