...
// SVG Filter Component — render this once near the root of any screen that
// uses the glass effect so `filter: url(#glass-distortion)` resolves.
...
// Original full-screen demo, kept for reference.
