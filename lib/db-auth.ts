...
function getDocClient() {
  // In production on Vercel, assume an AWS role via OIDC (AWS_ROLE_ARN).
  // Locally, omit `credentials` so the AWS SDK uses its default credential
  // chain (AWS_ACCESS_KEY_ID / AWS_SECRET_ACCESS_KEY env vars, shared config,
  // etc.), which lets sign in/sign up work without OIDC.
